...
import { Plus, Truck, Eye, Edit, Trash2, X, MapPin, Search, Filter } from 'lucide-react';
...
export default function ShipmentsPage() {
  ...
  const statuses = ['all', 'pending', 'picked_up', 'in_transit', 'out_for_delivery', 'delivered', 'cancelled'];
